...
if(WIN32 AND MINGW)
    ...
    # UI configuration - use ProgressOnly (no license, just progress bar)
    set(CPACK_WIX_UI_REF "WixUI_InstallDir")
    set(CPACK_WIX_PROPERTY_WIXUI_INSTALLDIR "INSTALL_ROOT")
    
    # Skip license by setting empty license
    set(CPACK_RESOURCE_FILE_LICENSE "${CMAKE_CURRENT_SOURCE_DIR}/LICENSE.txt")
    set(CPACK_WIX_LICENSE_RTF "${CMAKE_CURRENT_SOURCE_DIR}/wix_license.rtf")
